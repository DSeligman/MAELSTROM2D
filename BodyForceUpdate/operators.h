#ifndef OPERATORS_H    // To make sure you don't declare the function more than once by including the header multiple times.
#define OPERATORS_H
...
double mu1mu2mu1mu2(double *q,int j,int k,int nx, int ny);
#endif
