...
int main()
{
  ...
  t = clock();
  string line;
  ifstream myfile ("params_SkewShearLongerrun.txt");
  double * inputs=NULL;
  ...
  ofstream outputFile("output_SkewShearLongerrun/rho.txt"); // output filestream                           
  ofstream outputFile2("output_SkewShearLongerrun/ux.txt");    //read out the initial velocity flow           
  ofstream outputFile3("output_SkewShearLongerrun/uy.txt"); ////////                                          
  ofstream outputFile4("output_SkewShearLongerrun/E.txt");
