...
void dualtimestep_1(double * rho_np1, double *s1_np1, double *s2_np1,double * rhoE_np1,	\
  ...
  */
  ...
  convective_s1(q2,rhoux2_plus_p,rhouxuy,rhoax,dx,dy,nx,ny);
  convective_s2(q3,rhouxuy,rhouy2_plus_p,rhoay,dx,dy,nx,ny);
